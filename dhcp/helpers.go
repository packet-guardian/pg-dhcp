...
// IP2Int converts an IPv4 address to a uint32.  If the IP is IPv6, it will convert the last 4 bytes of the address.
...
// Int2IP converts a uint32 to an IPv4 address.
